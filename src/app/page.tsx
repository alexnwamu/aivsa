          ...
          <section className="container">
            <div className="mx-auto flex flex-col lg:flex-row  justify-center md:justify-between items-center gap-4 lg:gap-12">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[68px] leading-tight text-[#020817] font-outfit dark:text-white font-bold sm:mb-4 ">
                Turn your notes <br /> into a conversation.
              </h1>
              <div className="max-w-[563px] mt-4 lg:mt-0">
                <p className="text-[#84878E]  p-1.5 dark:text-[#B3B7BF] font-poppins text-sm sm:text-base md:text-[16px] mb-4">
                  Meet your AI Virtual Study Assistant. Upload your notes and
                  course materials, then chat with them instantly.{" "}
                  <br />
                  Get answers straight from what you've actually studied —
              ...
              <div className="mt-10 md:mt-[60px] flex flex-col lg:flex-row justify-between w-full gap-6 md:gap-[50px] items-stretch">
                <div className=" dark:bg-[#020817] p-6 sm:p-8 lg:p-[50px] rounded-md w-full max-w-[630px] bg-white">
                  ...
                  <p className="text-base sm:text-lg md:text-xl lg:text-[25px] font-poppins text-[#84878E] mt-2 dark:text-[#B3B7BF]">
                    Upload your notes, past questions, or course PDFs and turn
                    them into a personal study partner. Get explanations
                    pulled directly from your own material.
                  </p>
                </div>
                <div className=" dark:bg-[#020817] bg-white p-6 sm:p-8 lg:p-[50px] w-full max-w-[630px] rounded-md">
                  <h1 className="text-2xl sm:text-3xl md:text-[32px] lg:text-[48px] font-outfit font-bold dark:text-white ">
                    Ask Anything, Get Answers From Your Notes
                  </h1>
                  <p className="text-base sm:text-lg md:text-xl lg:text-[25px] font-poppins text-[#84878E] mt-2 dark:text-[#B3B7BF]">
                    Stop scrolling through pages looking for one line. Ask a
                    question and get the answer, sourced straight from what
                    you uploaded.
                  </p>
                </div>
              </div>
